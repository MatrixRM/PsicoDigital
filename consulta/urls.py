...
from .views import listar_consultas, realizar_consulta, adicionar_consulta, excluir_consulta
...
urlpatterns = [
    ...
    path("excluir/<int:consulta_id>/", excluir_consulta, name="excluir_consulta"),
]
